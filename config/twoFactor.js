export default {
  ...
  description: `احراز هویت دو مرحله‌ای (2FA) یک لایهٔ اضافی امنیت به گذرواژه می‌افزاید. 
  به کمک این قابلیت، با اجبار به ارائهٔ اطلاعات دیگری، به جز گذرواژه، می‌توان مطمئن شد شخصی که وارد یک حساب کاربری می‌شود، همان کسی است که ادعا می‌کند.
    
    \n\nاین اطلاعات دیگر، معمولاً چیزی است که شما آن را می‌دانید یا مختص شماست مثلاً چهرهٔ شما
    
    \n\n**نباید از شمارهٔ تلفن همراه خود برای احراز هویت دو مرحله‌ای استفاده کنید. **
    
    \n\nدر واقع بکوشید، تا کد احراز هویت دو مرحله‌ای از طریق پیامک برای شما ارسال نشود!     احراز هویت دو مرحله‌ای حداقل باید برای حساب‌های کاربری که می‌توانند باعث قفل شدن حساب‌های دیگر شما بشوند فعال شود، مثل: گوگل، اپل (Apple ID)  و ایمیل‌ها و حساب‌های بانکی.

    \n\nیک مثال: اگر با جیمیل خود در اسنپ نام‌نویسی کردید، اگر کسی گذرواژهٔ جیمیل شما را بداند و روی جیمیل، احراز هویت دو مرحله‌ای نداشته باشید، می‌تواند به اسنپ شما هم دست پیدا کند. بنابراین برای همهٔ حساب‌های کاربری مهم، احراز هویت دو مرحله‌ای را به کمک یکی از برنامه‌های زیر فعال کنید.
    مطمئن شوید احراز هویت دو مرحله‌ای را برای همهٔ حساب‌های کاربری سرویس‌هایی که از این قابلیت پشتیبانی می‌کنند فعال کرده‌اید.

    \n\n**توجه:** استفاده از نرم‌افزارهای همه‌کاره‌ای مثل 1Password هم برای مدیریت گذرواژه *و هم* برای احراز هویت دو مرحله‌ای، صحیح نیست و یک نقطه‌ضعف ایجاد می‌کند. وقتی برای احراز هویت دو مرحله‌ای، در حال انتخاب نرم‌افزار هستید به این نکته توجه کنید.  
