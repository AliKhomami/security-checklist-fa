export default {
  ...
  description: `کد عبور (PassCode) چهاررقمی برای گوشی تلفن همراه یا سایر دستگاه‌ها دیگر امن محسوب نمی‌شود. 
  باید دست‌کم از یک کد عبور ۶+ رقمی استفاده کنید، و برای امنیت بیشتر از یک کد عبور ۶+ حرفی که شامل عدد و حروف می‌شود استفاده کنید.
