...
\n\n  DNS اسمی مثل 'google.com' را به آدرس IP تبدیل می‌کند. به‌صورت پیش‌فرض، DNS کند و ناامن است. خیلی از شرکت‌های ارائه‌دهندهٔ اینترنت (ISP) اطلاعات فعالیت‌های اینترنتی شما را از طریق DNS رهگیری و ذخیره می‌کنند و حتی در بعضی موارد این اطلاعات را به تبلیغ‌کننده‌ها می‌فروشند.

  \n\nسایت Cloudflare یک ابزار کارا و حریم‌خصوصی-محور برای DNS ارائه داده که ترافیک اینترنت شما را در برابر شرکت‌های ارائه‌دهندهٔ خدمات اینترنت و افرادی که WiFi های عمومی را شنود می‌کنند محافظت می‌کند.
   1.1.1.1 از سرویس‌های DNS معمول سریع‌تر هم هست و باعث افزایش سرعت وب‌گردی شما می‌شود.
  \n\nیک جایگزین برای سرویس Cloudflare سرویس Quad9 است که روی امنیت و حریم شخصی وب‌گردی روزانهٔ شما تاکید دارد. 
    `,
  apps: [
    {
      name: "1.1.1.1",
