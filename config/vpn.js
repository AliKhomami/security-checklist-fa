export default {
  ...
  description: `یک VPN یا شبکهٔ خصوصی مجازی، ابزاری مفید برای امن کردن اتصال اینترنت است. VPN تضیمن می‌کند که اطلاعات ارسالی و دریافتی شما در اینترنت رمزگذاری شده و از شنود ترافیک اینترنت شما، جلوگیری می‌کند.

  \n\nباید از سرویس‌دهندهٔ‌ VPN استفاده کنید که مطمئن هستید اطلاعات شما را برای فروش، جمع‌آوری نمی‌کند.
  ...
  \n\nظاهراً طبق قوانین ایران، استفاده از VPN جرم نیست اما خرید و فروش آن جرم است. این مسئله نیاز به بررسی بیشتر دارد اما در هر حال VPNهایی که از طریق شبکهٔ شتاب و با پرداخت الکترونیک شارژ می‌شوند، با توجه به ممنوعیت قانونی، امن نیستند. 
    `,
  apps: [
    {
      name: "IVPN",
